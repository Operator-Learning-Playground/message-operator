...
var messagesResource = schema.GroupVersionResource{Group: "api.practice.com", Version: "v1alpha1", Resource: "messages"}

var messagesKind = schema.GroupVersionKind{Group: "api.practice.com", Version: "v1alpha1", Kind: "Message"}

// Get takes name of the message, and returns the corresponding message object, and an error if there is any.
func (c *FakeMessages) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Message, err error) {
	obj, err := c.Fake.
...
func (c *FakeMessages) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MessageList, err error) {
	obj, err := c.Fake.
...
func (c *FakeMessages) Create(ctx context.Context, message *v1alpha1.Message, opts v1.CreateOptions) (result *v1alpha1.Message, err error) {
	obj, err := c.Fake.
...
func (c *FakeMessages) Update(ctx context.Context, message *v1alpha1.Message, opts v1.UpdateOptions) (result *v1alpha1.Message, err error) {
	obj, err := c.Fake.
...
func (c *FakeMessages) UpdateStatus(ctx context.Context, message *v1alpha1.Message, opts v1.UpdateOptions) (*v1alpha1.Message, error) {
	obj, err := c.Fake.
...
func (c *FakeMessages) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(messagesResource, c.ns, listOpts)
...
func (c *FakeMessages) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Message, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(messagesResource, c.ns, name, pt, data, subresources...), &v1alpha1.Message{})
