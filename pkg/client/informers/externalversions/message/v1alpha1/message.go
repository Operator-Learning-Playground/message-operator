...
import (
	...
	versioned "github.com/myoperator/messageoperator/pkg/client/clientset/versioned"
	internalinterfaces "github.com/myoperator/messageoperator/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/myoperator/messageoperator/pkg/client/listers/message/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ApiV1alpha1().Messages(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ApiV1alpha1().Messages(namespace).Watch(context.TODO(), options)
			},
		},
		&messagev1alpha1.Message{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *messageInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&messagev1alpha1.Message{}, f.defaultInformer)
}
